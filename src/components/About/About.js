...
const About = ({about}) => {
    ...
    return (
        ...
        <p className={css(styles.blurb)}>WeatherWise is a fun, modern way to style your wardrobe depending on the weather. Great for kids, and adults who sometimes need that added inspiration when planning for the day!</p>
          </div>
          </div>
    ) 
  }
